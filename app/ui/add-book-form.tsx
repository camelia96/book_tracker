...
interface AddBookDialogProps {
  user: number, categories: categoriesModel[]
}

export function AddBook({ user, categories }: AddBookDialogProps) {
                  ...
                  (<AlertCustom
                    ...
                    color="error" />) : (<>
                      <Select name={field.name}
                        ...
                        <SelectTrigger aria-invalid={fieldState.invalid} id="categorySelect" className=" text-xs w-45">
